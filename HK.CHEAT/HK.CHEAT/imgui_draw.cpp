...
ImFont* ImFontAtlas::AddFontDefault(const ImFontConfig* font_cfg_template)
{
    ...
    if (font_cfg.Name[0] == '\0') strcpy(font_cfg.Name, "Times.TTF, 12px");
    if (font_cfg.SizePixels <= 0.0f) font_cfg.SizePixels = 12.0f;

    ImFont* font = AddFontFromFileTTF("Platform\\VGUI\\Fonts\\Times.TTF", font_cfg.SizePixels, &font_cfg, GetGlyphRangesDefault());
    return font;
}
